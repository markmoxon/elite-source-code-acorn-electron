\ ******************************************************************************
\
\ DISC ELITE SHIP BLUEPRINTS FILE O
\
...
\    Summary: Ship blueprints lookup table for the D.MOO file
...
\       Type: Variable
\   Category: Drawing ships
\    Summary: Ship blueprints default NEWB flags for the D.MOO file
\  Deep dive: Ship blueprints in the disc version
...
\ ******************************************************************************
 ...
 SAVE "3-assembled-output/D.MOO.bin", CODE%, CODE% + &0A00
