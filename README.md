...
This repository contains source code for Ian Bell and David Braben's classic game Elite on the Acorn Electron, with every single line documented and (for the most part) explained. It has been reconstructed by hand from a disassembly of the original game binaries.
